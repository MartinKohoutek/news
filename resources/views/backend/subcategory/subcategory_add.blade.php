                ...
                <div class="card-body p-5">
                    ...
                    <form action="{{ route('store.subcategory') }}" method="post" class="row g-3" id="myForm">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="subcategory_name" class="form-control @error('subcategory_name') is-invalid @enderror" id="subcategory_name">
                        ...
                        <div class="col-12">
                            <input type="submit" class="btn btn-primary px-5" value="Add SubCategory" />
                        </div>
                    </form>
                </div>
            </div>
