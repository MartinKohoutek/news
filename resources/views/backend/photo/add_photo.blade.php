                    ...
                    <form action="{{ route('store.photo.gallery') }}" method="post" class="row g-3" id="myForm" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3 mb-3">
                            <div class="col-md-6 form-group">
                                <label for="photo_title" class="form-label">Title (for all Images)</label>
                                <input type="text" name="photo_title" class="form-control" id="photo_title">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label for="multi_image" class="form-label">Choose Photos</label>
                        ...
                        <div class="col-12">
                            <input type="submit" class="btn btn-primary px-5" value="Add Photos" />
                        </div>
                    </form>
                </div>
            </div>
