            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-primary">Add Video</h5>
                    </div>
                    <form action="{{ route('store.video.gallery') }}" method="post" class="row g-3" id="myForm" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mt-3 mb-3">
                            <div class="col-md-6 form-group">
                                ...
                                <img src="{{ asset('upload/no_image.jpg') }}" class="border" alt="" id="showImage" style="width: 200px; height: 150px;">
                            </div>
                        </div>

                        <div class="row">    
                            <div class="col-12">
                                <input type="submit" class="btn btn-primary px-5" value="Add Video" />
                            </div>
                        </div>
                    </form>
                </div>
